            ...
            <div className="max-w-[1500px] mx-auto lg:px-4 sm:px-6">
                    ...
                    <div className="flex items-center gap-8 flex-shrink-0">
                        ...
                        <Link to="/login" className="flex items-center gap-3 group">
                            ...
                            <div className="flex flex-col items-start leading-none gap-1">
                                <span className="text-[11px] text-neutral-500 dark:text-neutral-400 font-medium">Bonjour, Identifiez-vous</span>
                                <span className="text-sm font-bold text-neutral-900 dark:text-white group-hover:text-[#6aa200] transition-colors">Mon Compte</span>
                            </div>
                        </Link>
                ...
                <div className="lg:hidden fixed top-0 left-0 right-0 z-[60] p-3 flex flex-col gap-2 pointer-events-none">
                    ...
                    <div className="pointer-events-auto w-full bg-white/80 dark:bg-neutral-900/80 backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-neutral-200/50 dark:border-neutral-800/50 rounded-[2rem] p-1.5 pr-2 flex items-center justify-between transition-all duration-300">
                        ...
                        {/* User Pill (Left) */}
                        <Link to="/profile" className="flex items-center gap-3 bg-white/50 dark:bg-neutral-800/50 rounded-full p-1 pr-5 border border-white/20 shadow-sm transition-transform active:scale-95">
                            <div className="w-10 h-10 rounded-full border-2 border-white dark:border-neutral-950 overflow-hidden shadow-sm">
                                <img 
                                    src="https://i.pinimg.com/1200x/6f/e2/7f/6fe27fc037dd1eb2755f925fde7727be.jpg" 
                                    alt="Profile" 
                            ...
                            <div className="flex flex-col leading-none">
                                ...
                                <span className="text-xs font-black text-neutral-800 dark:text-neutral-100">Frédérick</span>
                            </div>
                        </Link>
