...
/**
 * Service Partner - Gère l'enregistrement en 3 étapes et les opérations CRUD spécifiques
 */
public interface PartnerService {
     ...
     */
    PartnerResponseDto registerStep1(PartnerRegisterStep1RequestDto dto);
