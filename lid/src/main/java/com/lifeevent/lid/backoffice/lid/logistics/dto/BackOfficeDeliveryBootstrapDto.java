...
@AllArgsConstructor
@Builder
public class BackOfficeDeliveryBootstrapDto {
    private LogisticsKpisDto kpis;
    private BackOfficeSettingShopProfileDto appConfig;
    private List<BackOfficeShipmentDto> activeShipments;
    private PageResponse<BackOfficeShipmentDto> deliveriesPage;
