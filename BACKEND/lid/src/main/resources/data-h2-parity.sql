...
-- Categories (static seed for local onboarding)
MERGE INTO category (id, is_activated, order_idx, created_at, updated_at, created_by, image_url, name, parent_slug, slug, updated_by, level) KEY(id) VALUES
  (1, TRUE, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'seed', NULL, 'Mode & Accessoires', NULL, 'mode-accessoires', NULL, 'PRINCIPALE'),
  (2, TRUE, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'seed', NULL, 'Beauté & Santé', NULL, 'beaute-sante', NULL, 'PRINCIPALE'),
  (3, TRUE, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'seed', NULL, 'Maison & Déco', NULL, 'maison-deco', NULL, 'PRINCIPALE'),
  (4, TRUE, 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'seed', NULL, 'High-Tech', NULL, 'high-tech', NULL, 'PRINCIPALE'),
  (5, TRUE, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'seed', NULL, 'Alimentation', NULL, 'alimentation', NULL, 'PRINCIPALE');
