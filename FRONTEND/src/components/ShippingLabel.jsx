      ...
      <div className="w-[400px] bg-white border border-black p-5 text-[11px] font-sans text-black leading-tight print:border-none print:shadow-none">
        ...
        <div className="flex justify-between items-start border-b border-black pb-3 mb-3">
          ...
          <div className="text-right text-[10px]">
            <p className="font-semibold uppercase">Life Distribution</p>
            <p>Cocody, Abidjan</p>
            <p>Côte d'Ivoire</p>
        ...
        <div className="mb-3">
          ...
          <div className="border border-black p-2 mt-1">
            <p className="font-semibold">Life Distribution</p>
        ...
        {/* BARCODE REALISTE */}
        <div className="mb-2">
          <div className="h-20 flex items-end justify-center gap-[2px]">
            {[
              2,1,3,1,2,4,1,2,3,1,2,1,4,1,2,3,1,2,4,1,
              2,3,1,2,1,3,2,1,4,1,2,3,1,2,1,4,2,1,3,1,
            ].map((w, i) => (
              <div
                key={i}
                className="bg-black"
          ...
          <p className="text-center text-[11px] tracking-[3px] mt-1">
